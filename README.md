...
**School Library** is a Ruby base OOP Program to organize Books of a school amongs students, teachers and more...

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

Coded entirely with Ruby
...
Initialize the IRB console and make sure to be inside the cloned repository folder:
